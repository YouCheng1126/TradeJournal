...
export const SummaryStats: React.FC<SummaryStatsProps> = ({ trades, commission }) => {
    ...
    // Global click listener to close active tooltip when clicking outside
    useEffect(() => {
            ...
            <div className="flex flex-col gap-1 py-2 relative">
                <div className="flex items-center gap-1.5 group">
                    ...
                    <div className="relative flex items-center">
                        ...
                        <div 
                            className={`text-slate-400 hover:text-primary transition-colors p-0.5 rounded-full cursor-pointer ${isOpen ? 'text-primary' : ''}`}
                            onClick={(e) => {
                        ...
                        {isOpen && (
                            <div 
                                ...
                                onClick={(e) => e.stopPropagation()} // Prevent clicking inside tooltip from closing it
                            >
