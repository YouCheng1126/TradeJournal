...
const STORAGE_KEY_METRIC = 'zella_day_chart1_metric';
const STORAGE_KEY_METRIC_2 = 'zella_day_chart1_metric_2';

export const Chart1: React.FC<Chart1Props> = ({ data }) => {
    const [metric, setMetric] = useState<MetricType>('netPnL');
                                    ...
                                    return (
                                        <div className="bg-slate-800 border border-slate-600 p-3 rounded-lg shadow-xl text-xs">
                                            ...
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className={`font-bold ${metric === 'netPnL' ? (val1 >= 0 ? 'text-emerald-400' : 'text-red-400') : 'text-white'}`}>
